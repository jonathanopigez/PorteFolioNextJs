...
useEffect(() => {
  ...
  return (
    <div className=' flex flex-col relative h-screen md:text-left md:flex-row max-x7xl px-10 justify-evenly mx-auto items-center md:max-w-[100%]'>
        ...
        className='space-y-10 xs:space-y-0 md:px-10 md:max-w-[60%] '>
          <h4 className='pt-2 sm:text-3xl font-semibold md:text-4xl xs:text-1xl text-center'>Une présentation <span className='text-[#6E61Ca]'>s&apos;impose !</span> </h4>
